...
if ($onGae) {
    ...
    define('DB_NAME', getenv('CLOUD_SQL_DB_NAME'));
    /** Production login info */
    define('DB_HOST', getenv('CLOUD_SQL_DB_HOST'));
    define('DB_USER', getenv('CLOUD_SQL_DB_USER'));
    define('DB_PASSWORD', getenv('CLOUD_SQL_DB_PASS'));
} else {
